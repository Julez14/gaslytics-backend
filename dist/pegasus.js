...
if (!TWELVE_LABS_API_KEY) {
    ...
    console.error("Get your API key from: https://playground.twelvelabs.io/dashboard/api-key");
    process.exit(1);
}
async function main() {
    try {
        ...
        console.log("\n📹 Uploading video...");
        const videoPath = path.join(__dirname, "..", "assets", "shell-of-a-woman-2008-hd---revolutionary-road-78-movie-clip.mp4");
